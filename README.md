...
|---|---|---|
| **1** | `main` | Головне фото: ідеально білий фон, без тексту/водяних знаків |
...
Якщо ідеального головного фото не знайдено — обирається найсвітліше зображення як альтернатива, а папка позначається у звіті для ручної перевірки.
