...
Якщо ідеального головного фото не знайдено — обирається найбільш підходяще зображення (там де найкраще видно товар) на основі оцінки білизни фону, а папка позначається у звіті для ручної перевірки.
